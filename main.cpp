...
int video_main(string videoname, string filename) {
    ...
    while (1)
    {
        ...
        //성민 컴
        if (count == 10) imwrite("D:\\OneDrive - 공주대학교\\자율주행 프로젝트\\curb_line_test_encoding.jpg", img_annotated);
...
int main(int, char**)
{
    ...
    //(성민 컴퓨터 환경)
    video_main("D:\\OneDrive - 공주대학교\\자율주행 프로젝트\\curb_line_test_encoding.mp4", "D:\\OneDrive - 공주대학교\\자율주행 프로젝트\\curb_line_test_encoding.avi");
